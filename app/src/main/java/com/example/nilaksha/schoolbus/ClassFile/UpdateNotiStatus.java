...
public abstract class UpdateNotiStatus extends AsyncTask<Void, Void, String> {

    String id,respond;

    public UpdateNotiStatus(String id) {
        this.id = id;
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            this.respond = okHTTPClient.updateNotificationStatus(id);
