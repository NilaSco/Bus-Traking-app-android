...
public abstract class DropPickLocation extends AsyncTask<Void, Void, String> {

    private String name,respond;

    public DropPickLocation(String name) {
        this.name = name;
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            this.respond = okHTTPClient.getDropPickLocation(name);
