...
public abstract class SendEmail extends AsyncTask<Void, Void, String> {

    private String amount,due,income,sendemail,respond;

    public SendEmail(String amount, String due, String income, String sendemail) {
        this.amount = amount;
        this.due = due;
        this.income = income;
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            this.respond = okHTTPClient.SendEmailReport(amount,due,income,sendemail);
