...
public abstract class PickFromSchool extends AsyncTask<Void, Void, String> {
    String id,respond;

    public PickFromSchool(String id) {
        this.id = id;
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            this.respond = okHTTPClient.updateAttendancePickSchool(id);
