...
/**
 * Created by Nilaksha on 11/3/2019.
 */

public abstract class LoadDriversChildren extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            this.respond = okHTTPClient.getDriversChildren();
