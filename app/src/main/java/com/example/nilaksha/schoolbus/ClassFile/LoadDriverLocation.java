...
public abstract class LoadDriverLocation extends AsyncTask<Void, Void, String> {

    String id,respond;

    public LoadDriverLocation(String id) {
        this.id = id;
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            this.respond = okHTTPClient.getDriverLocation(id);
