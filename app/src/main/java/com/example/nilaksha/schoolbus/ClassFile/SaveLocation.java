...
public abstract class SaveLocation extends AsyncTask<Void, Void, String> {

    String lat,lng,respond;

    public SaveLocation(String lat, String lng) {
        this.lat = lat;
        this.lng = lng;
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            this.respond = okHTTPClient.saveLocation(lat,lng);
